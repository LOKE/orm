...
function Schema(opts) {
  ...
  this.primaryFields = this.fields.filter(function (f) {return f.primary; });
  if (!this.primaryFields.length) {
    // Default primary key:
    var idField = this.specifiers.id = new Specifier('id', {type: Type.Id, primary: true, autoIncrement: true});
