    ...
    return P.all(schema.relations.map(function (relation) {
      ...
      if (relation.type === Type.HasMany) {
        ...
        return P.all(value.map(function (subdoc) {
          ...
          return relation.target.delete(subdoc, document, repo, relation, transaction)
          .then(function () {
        ...
        .then(function () {
          if (oldValue && (oldValue !== value) && (oldValue[primaryKeyAttribute] !== value[primaryKeyAttribute])) {
            ...
            .then(function () {
              ...
              return mod.deleting = relation.target.delete(oldValue);
            })
            .then(function () {
              delete mod.deleting;
        ...
        .then(function () {
          if (value) return relation.target.persist(value, document, repo, relation);
        })
        .then(function () {
